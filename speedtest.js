...
/*
   ...
   - 1: here you can add test points. You only need to do this if you want to use multiple test points.
        A server is defined as an object like this:
        {
            ...
            server:"http://lrgs.ftsm.ukm.my",     <---- URL to your server. You can specify http:// or https://. If your server supports both, just write // without the protocol
            dlURL:"users/a172275/speedtest/backend/garbage.php"    <----- path to garbage.php or its replacement on the server
            ulURL:"users/a172275/speedtest/backend/empty.php"    <----- path to empty.php or its replacement on the server
            pingURL:"users/a172275/speedtest/backend/empty.php"    <----- path to empty.php or its replacement on the server. This is used to ping the server by this selector
            getIpURL:"users/a172275/speedtest/backend/getIP.php"    <----- path to getIP.php or its replacement on the server
        }
